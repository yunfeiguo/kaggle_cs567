...
fn_out_train='/home/yunfeiguo/projects/kaggle_cs567/results/20151207_mixreg_pred_train.csv'
fn_out_test='/home/yunfeiguo/projects/kaggle_cs567/results/20151207_mixreg_pred_test.csv'
...
z = pd.DataFrame(pd.DataFrame.dot(trainCleaned[featureCombo],model.coef_))
